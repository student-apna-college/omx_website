        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-[1200px] mx-auto px-6">
          ...
          {[
            ...
            <div key={i} className="bg-blue-50 rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition">
              <div className="text-[#000033] mb-2 flex justify-center">{stat.icon}</div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <Link href="/services" className="inline-flex items-center gap-3 group">
              <span className="text-sm font-bold uppercase border-b-2 border-[#000033] pb-1">
...
// stella indusstries
// batik airways
// rohde and schwarz india pvt ltd
// ambica steels ltd
// forties convert to  international hospital ltd
// international oncology services
// jubilant   not found
// surya roshni
// aourigene discovery  not found
