...
export default function CoreTeamPage() {
  return (
    <div className="min-h-screen bg-gray-50 px-4 sm:px-6 md:px-12 lg:px-20 py-12 md:py-16">
      
      {/* Heading Section */}
      <div className="max-w-3xl mx-auto text-center mb-12 md:mb-16">
        
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
          Meet Our <span className="font-medium  text-[#000033]">Core Team</span>
        ...
        <p className="text-gray-600 mt-6 text-sm sm:text-base leading-relaxed">
          In the dynamic and visionary landscape of <span className="font-bold  text-[#000033]">Om Logistics Supply Chain</span> our core team stands as the driving force behind our continued success. As strategic leaders, they bring a wealth of experience, insight, and innovation
        </p>
