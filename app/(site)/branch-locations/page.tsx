...
const branchData = [
  ...
  { city: "Pune", state: "Maharashtra", category: "Logistics Pune", address: "Plot no 1, Survey no 163/A Near Anup Hotel,Lane no 6 Vishrantwadi Airport Raod Pune Pin-411032", contact: "omxinfo@omx.in"}
];
      ...
      <section className="py-16 md:py-24 max-w-[1400px] mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {branchData.map((branch, i) => (
            <div key={i} className="group relative p-6 rounded-2xl bg-white border shadow-sm hover:shadow-xl transition overflow-hidden">
              <Building2 size={120} className="absolute -top-8 -right-8 text-green-100 group-hover:text-green-200 transition" />
