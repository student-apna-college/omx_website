      ...
      <div className="max-w-[1100px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          {data.map((item, i) => (
            ...
            <div
              key={i}
              className="rounded-2xl border border-slate-200 bg-[#1e3a8a] hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out duration-300"
            >
              ...
              >
                ...
                <h3 className="font-medium text-white text-base md:text-sm">
                  {item.q}
                </h3>
