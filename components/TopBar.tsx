    ...
    <div className="w-full bg-[#0a0a0a] text-white py-2 px-6 md:px-12 border-b border-white/5">
      <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row justify-between items-center gap-3">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/client-login" className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] bg-[tomato] px-4 py-2 rounded-md hover:bg-white hover:text-black transition-all">
            <ShieldCheck size={12} />
            Client Login
          </Link>
        </div>
